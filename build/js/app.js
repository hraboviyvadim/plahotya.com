  ...
  _createClass(Modal, [{
    ...
    value: function init() {
      ...
      this.link.on('click', function (e) {
        var imgLink = (0, _jquery2.default)(this).attr('href');
        var imgText = (0, _jquery2.default)(this).data('alt');
...
var _barba = __webpack_require__(3);
...
(0, _jquery2.default)(document).ready(function () {
  ...
  var Contacts = _barba2.default.BaseView.extend({
    ...
    onEnterCompleted: function onEnterCompleted() {
      (0, _jquery2.default)('[data-title]').removeClass('active');
      (0, _jquery2.default)('[data-title="contact"]').addClass('active');
    },
    onLeave: function onLeave() {
      hideNav();
    }
